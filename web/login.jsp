    ...
    <div class="container">
        <div class="login-card shadow-lg">
            <div class="text-center">
                ...
                <div style="font-size:1.1rem;color:#bbb;">Login ke Akunmu</div>
            ...
            <form method="POST" action="AuthController" class="mt-3">
                ...
                <% } %>
                <button type="submit" class="btn btn-cinemagz w-100 my-2 py-2">Login</button>
            </form>
            <div class="mt-4 text-center">
                <span style="color:#bbb;">Belum punya akun?</span>
                <a href="register.jsp" class="register-link ms-1">Daftar sekarang</a>
            </div>
        </div>
