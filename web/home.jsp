        ...
        <div class="main-content">
            ...
            <div class="banner mb-4">
                ...
                <div class="banner-content">
                    ...
                    <a href="RegisteredUserController?action=addToWatchlist&contentId=<%= firstContent.getId()%>" class="banner-watchlist">Watchlist</a>
                    <button class="banner-fav" onclick="toggleFavorite('<%= firstContent.getId()%>')"><i class="fa fa-heart"></i></button>
                </div>
                <% } else { %>
            ...
            <div class="movie-grid">
                ...
                <div class="movie-card">
                    ...
                    <div class="movie-body">
                        <a href="RegisteredUserController?action=viewContent&contentId=<%= content.getId()%>" style="text-decoration: none; color: inherit;">
