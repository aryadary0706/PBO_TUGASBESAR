...
public class movie extends Content implements ContentPage {
    ...
    public movie(int duration, int id, String title, Date releaseDate, String sinopsis, List<String> aktor, List<String> genre, Date releaseDate, String imageUrl) {
        super(id, title, releaseDate, sinopsis, aktor, genre, imageUrl);
        this.duration = duration;
    }

    public movie(int duration, int id, String title, String synopsis, List<String> genres, List<String> actors, Date releaseDate, List<Review> reviews) {
        super(id, title, synopsis, genres, actors, releaseDate, reviews);
        this.duration = duration;
    }
    
    public movie(int duration, int id, String title, String synopsis, Date releaseDate, Date releaseDate)
