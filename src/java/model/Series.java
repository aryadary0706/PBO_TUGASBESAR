...
public class Series extends Content implements ContentPage {
    ...
    public Series(int totalEpisode, int totalDuration, int season,
                  int id, String title, Date releaseDate,
                  String synopsis, List<String> actors, List<String> genres,
                  String imageUrl) {
    ...
    public double getAverageRating() {
        ...
        return reviews.stream()
                .mapToDouble(review -> review.getRating().getAverageRate())
                .average()
                .orElse(0.0);
    }
