<%-- 
    Document   : series
    Created on : Jun 7, 2025, 7:13:18 PM
    Author     : user
--%>
...
<%
    List<Content> seriesList = (List<Content>) request.getAttribute("series");
    request.setAttribute("currentPage", "series");
%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Series - CineMagz</title>
    ...
    <body>
        <div class="sidebar">
            ...
            <div class="nav-menu">
                ...
                <a href="series.jsp" class="active"><i class="fa fa-film icon"></i>Series</a>
        ...
        <div class="main-content">
            <div class="header-bar">
                <div class="header-tabs">
                    ...
                    <a href="series.jsp" class="active">Series</a>
                </div>
            ...
            <div class="movie-grid">
                <% if (seriesList != null && !seriesList.isEmpty()) {
                    for (Content content : seriesList) {
                            ...
                            <div class="movie-card">
                                ...
                                <div class="movie-body">
                                    ...
                                    <div class="movie-meta">
                                        ...
                                        <%= series.getTotalEpisode() %> Episodes
                                    </div>
                                </div>
                            </div>
                <% }
